    ...
    def process(self, person_img, cloth_img, out_dir, original_img=None, clean_img=None):
        ...
        if clean_img is not None:
            ...
            try:
                ...
                remover_model_path = base_dir / "models" / "SegFormerB2Clothes" / "segformer_b2_clothes.onnx"
                if not remover_model_path.exists():
                    remover_model_path = base_dir / "models" / "segformer_b2_clothes.onnx"
...
def main():
    ...
    DEFAULT_PERSON = "person.png"
    DEFAULT_CLOTH = "cloth.png"
    
    parser.add_argument("--person", type=str, default=DEFAULT_PERSON, help="Path to person image")
    parser.add_argument("--cloth", type=str, default=DEFAULT_CLOTH, help="Path to cloth image")
