...
class FixedShirtPantsWarper:
    ...
    def __init__(self, b2_model_path, b3_model_path):
        ...
        sam_path = base_dir / "models" / "sam" / "sam_vit_b_01ec64.pth"
    ...
    def process(self, person_img, cloth_img, output_dir, original_img=None, clean_img=None):
        ...
        try:
            ...
            # Use the provided B2 model path for ClothRemover
            print(f"Initializing Cloth Remover (shirt mode) from: {self.b2_model_path if hasattr(self, 'b2_model_path') else b2_model_path}")
            remover = ClothRemover(str(b2_model_path))
