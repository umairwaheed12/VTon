...
from .shirt import FixedShirtPantsWarper
from .pants import LBSPantsWarper
...
class VTONCoordinator:
    ...
    def process(self, person_path, cloth_path, output_dir, mode=None):
        ...
        if mode == 'lower':
            ...
            result = shirt_warper.process(pants_only_image, cloth_img, output_dir, original_img=pants_only_image)
...
def main():
    ...
    # Example paths (Placeholder for testing)
    PERSON = "person.png"
    CLOTH = "cloth.png"
    OUTPUT = Path("coordinator_test")
