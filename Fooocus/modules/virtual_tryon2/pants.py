...
class LBSPantsWarper:
    def __init__(self, seg_model_path, b3_path=None):
        ...
        # Initialize Unified Masker (Standardized SAM path)
        self.masker = VTONMasker(seg_model_path=seg_model_path, sam_model_path=str(sam_path) if sam_path.exists() else None)
